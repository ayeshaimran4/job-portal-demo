                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="create-job-flex">
                        ...
                        <div className="lg:w-1/2 w-full">
                            ...
                            <input type="text" placeholder="e.g: Microsoft" defaultValue={companyName}
                    ...
                    <div className="create-job-flex">
                        ...
                        <div className="lg:w-1/2 w-full">
                            ...
                            <input type="text" placeholder="e.g lahore" defaultValue={jobLocation}
                    ...
                    <div className="create-job-flex">
                        <div className="lg:w-1/2 w-full">
                            ...
                            <input type="date" placeholder="e.g 2024-04-28" defaultValue={postingDate}
